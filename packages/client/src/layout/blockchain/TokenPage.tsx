...
import TransactionActionList from 'modules/blockchain/TransactionActionList'
...
const IconLink = ({ url, title, icon }: { url: string; title: string; icon: IconDefinition }): ReactElement => {
  return (
    <li>
        ...
        <>
          ...
          {price && (
            <section className="my-tokenpage-price">
              ...
              <TokenAmount amount={price} color="primary" />
