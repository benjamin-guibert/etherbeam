...
import { parseTransactionData, parseTokenData } from 'libraries/ethereum/severParsers'
import { AddressType, HistoryTime, TransactionMethodParameterType, TransactionStatus } from 'libraries/ethereum/types'
...
describe('Parse transaction data', () => {
  it('should parse a transaction', () => {
    ...
    const transaction = parseTransactionData(data)
