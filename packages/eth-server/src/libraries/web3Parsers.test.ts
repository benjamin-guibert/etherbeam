...
describe('Parse Web3 transaction', () => {
  ...
  beforeAll(() => {
    ...
    result = parseWeb3Transaction(web3Transaction, TransactionStatus.mined, data, new Date(2020, 4, 5, 11, 22, 33))
  })
...
describe('Parse Web3 transaction receipt', () => {
  ...
  describe('Validated', () => {
    beforeAll(() => {
      ...
      result = parseWeb3TransactionReceipt(web3Receipt, data)
    })
